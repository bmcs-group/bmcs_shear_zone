...
class DICCrackCOR(bu.Model):
    ...
    dsf = tr.Property
    def _get_dsf(self):
        return self.dic_crack.dsf

    dic_grid = tr.Property
    def _get_dic_grid(self):
        return self.dic_crack.dsf.dic_grid
    ...
    @tr.cached_property
    def _get_U0_a(self):
        return self.dic_grid.U_ija[self.y_ref_i,0,:]
    ...
    def _get_U_ref_ija(self):
        ...
        U_ref_ija = self.dic_grid.U_ija - U0_11a
        return U_ref_ija
    ...
    def _get_X_ref_ija(self):
        X_ref_ija = self.dic_grid.X_ija + self.U_ref_ija
        return X_ref_ija
    ...
    def _get_alpha_ref(self):
        ...
        X_ref_ja = (self.dic_grid.X_ija[self.y_ref_i, :self.y_ref_j_max,:] +
    ...
    def _get_displ_grids_scaled(self):
        ...
        w_ref_aij = np.array([u_ref_ija[..., 1], -u_ref_ija[..., 0]])
        w_ref_ija = np.einsum('aij->ija', w_ref_aij)
        xw_ref_ija_scaled = xu_mid_ija_scaled + w_ref_ija * self.dic_grid.U_factor
    ...
    def update_plot(self, axes):
        ...
        if self.show_init:
            ...
            X_aij = np.einsum('ija->aij', self.dic_grid.X_ija)
